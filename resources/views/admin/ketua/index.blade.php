            ...
            <table class="w-full text-left text-xs sm:text-sm" id="candidate-table">
                ...
                <tbody class="divide-y divide-slate-100" id="candidate-table-body">
                    @forelse($kandidat as $k)
                        ...
                        @endphp
                        <tr class="hover:bg-slate-50/80 transition candidate-row" data-name="{{ strtolower($k->nama) }}" data-nik="{{ $k->nik }}" data-visi="{{ strtolower($k->visi) }}">
                            <!-- Ballot Number -->
                            <td class="py-3 px-3 text-center">
                                <span class="w-9 h-9 rounded-xl bg-blue-600 text-white font-black text-sm flex items-center justify-center mx-auto shadow-xs">
                                    {{ $k->nomor_urut }}
                                </span>
                            </td>
