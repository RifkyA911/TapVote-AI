...
@section('title', 'Laporan Pemenang Pengawas Koperasi')
...
<div class="space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2.5 self-start sm:self-auto">
            <a href="{{ route('admin.reports.pengawas.export') }}" class="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-xs transition flex items-center space-x-1.5 cursor-pointer">
        ...
        <div class="p-6 sm:p-8 rounded-3xl bg-emerald-50/80 border-2 border-emerald-200 shadow-sm relative overflow-hidden">
            <div class="flex flex-col sm:flex-row items-center gap-6 relative z-10">
                <div class="relative">
                    ...
                    <span class="absolute -bottom-2 -right-2 px-3 py-1 rounded-full bg-emerald-600 text-white font-mono font-bold text-xs shadow-md">
